 ...
 *
 */
class Doci extends CI_Controller {
	...
	public function index()
	{
		...
		$data_out['url']='proc_doc-doci-index';
		
		$data_out['field_search_start']='doci_name';
		//默认排序规则
		$data_out['field_search_rule_default']='{"field":"doci_name","field_s":"档案名称","table":"oa_doc_item","value":"","rule":"like","group":"search","editor":"text"}';
		$data_out['field_search_rule']='
		    {"id":"doci_name","text":"档案名称","rule":{"field":"doci_name","field_s":"档案名称","table":"oa_doc_item","value":"'.element('doci_name',$data_get).'","rule":"like","group":"search","editor":"text"}},
		...
		/************载入视图 ****************/
		$arr_view[]='proc_doc/doci/index';
		$arr_view[]='proc_doc/doci/index_js';
	...
	public function get_json()
	{
		...
		$arr_search['where']=" AND doci_page_now !=0";
