 ...
 *
 */
class Hr_train extends CI_Controller {
	...
	public function index()
	{
		...
		$data_out['title']='员工培训记录';
		$data_out['time']=time();
		$data_out['url']='proc_hr-hr_train-index';
		
		$data_out['field_search_start']='hr_t_time_start_1,hr_t_time_start_2,hr_t_time_end_1,hr_t_time_end_2,hr_t_name';
		$data_out['field_search_rule_default']='{"field":"hr_t_name","field_s":"培训名称","table":"hr_train","value":"","rule":"like","group":"search","editor":"text"}';
		$data_out['field_search_rule']='
		{"id":"hr_t_time_start_1","text":"起始时间-始","rule":{"field":"hr_t_time_start_1","field_r":"hr_t_time_start","field_s":"起始时间-始","table":"hr_train","value":"'.element('hr_t_time_start_1',$data_get).'","rule":">=","group":"search","editor":"datebox"}}
		,{"id":"hr_t_time_start_2","text":"起始时间-止","rule":{"field":"hr_t_time_start_2","field_r":"hr_t_time_start","field_s":"起始时间-止","table":"hr_train","value":"'.element('hr_t_time_start_2',$data_get).'","rule":"<=","group":"search","editor":"datebox"}}
		,{"id":"hr_t_time_end_1","text":"截止时间-始","rule":{"field":"hr_t_time_end_1","field_r":"hr_t_time_end","field_s":"截止时间-始","table":"hr_train","value":"'.element('hr_t_time_end_1',$data_get).'","rule":">=","group":"search","editor":"datebox"}}
		,{"id":"hr_t_time_end_2","text":"截止时间-止","rule":{"field":"hr_t_time_end_2","field_r":"hr_t_time_end","field_s":"截止时间-止","table":"hr_train","value":"'.element('hr_t_time_end_2',$data_get).'","rule":"<=","group":"search","editor":"datebox"}}
		,{"id":"hr_t_name","text":"培训名称","rule":{"field":"hr_t_name","field_s":"培训名称","table":"hr_train","value":"'.element('hr_t_name',$data_get).'","rule":"like","group":"search","editor":"text"}}
		';
		...
		/************载入视图 ****************/
		$arr_view[]='proc_hr/hr_train/index';
		$arr_view[]='proc_hr/hr_train/index_js';
	...
	public function get_json()
	{
		...
		{
			$arr_search['sort']='hr_t_time_start';
		...
		if( $query )
		{
			if( ! $field_q ) $field_q="hr_t_time_start";
		...
		if (count($rs['content']) > 0)
		{
			foreach($rs['content'] as $k => $v)
			{
				...
				foreach ($arr_field_search as $f) {
					...
					{
						default:
							if(isset($GLOBALS['m_hr_train']['text'][$f]) && isset($GLOBALS['m_hr_train']['text'][$f][$v[$f]]) )
							$v[$f]=$GLOBALS['m_hr_train']['text'][$f][$v[$f]];
					}
	...
	public function import()
	{
		...
		if($row_num)
		{
			...
			while (TRUE)
			{
				...
				$arr_post['btn']='save';
				$arr_rtn=$this->m_hr_train->load($arr_get,$arr_post);
