 ...
 *
 */
class Hr_dim extends CI_Controller {
	...
	public function __construct()
	{
		...
		$this->load->model('proc_hr/m_hr_dim');
	}
	...
	public function index()
	{
		...
		$data_out['title']='离职索引';
		$data_out['time']=time();
		$data_out['url']='proc_hr-hr_dim-index';

		$data_out['field_search_start']='dim_code,c_id,dim_cause,dim_note,ppo';
		$data_out['field_search_rule_default']='{"field":"dim_code","field_s":"单据编号","table":"hr_dim","value":"","rule":"like","group":"search","editor":"text"}';
		$data_out['field_search_rule']='
		{"id":"dim_code","text":"单据编号","rule":{"field":"dim_code","field_s":"单据编号","table":"hr_dim","value":"'.element('dim_code',$data_get).'","rule":"like","group":"search","editor":"text"}},
		{"id":"c_id","text":"离职人员","rule":{"field":"c_id","field_s":"离职人员","table":"hr_dim","value":"'.element('c_id',$data_get).'","rule":"like","group":"search","editor":"text"}},
		{"id":"dim_cause","text":"离职原因","rule":{"field":"dim_cause","field_s":"离职原因","table":"hr_dim","value":"'.element('dim_cause',$data_get).'","rule":"like","group":"search","editor":"text"}},
		{"id":"dim_note","text":"备注","rule":{"field":"dim_note","field_s":"备注","table":"hr_dim","value":"'.element('dim_note',$data_get).'","rule":"like","group":"search","editor":"text"}},
		{"id":"ppo","text":"节点","rule":{"field":"ppo","field_s":"节点","table":"hr_dim","value":"'.element('ppo',$data_get).'","rule":"in","group":"search","editor":{
        	"type":"combotree",
				"options":{
				"valueField": "id",
				"textField": "text",
				"panelHeight":"auto",
				"multiple":"true",
				"data":['.get_json_for_arr($GLOBALS['m_hr_dim']['text']['ppo']).']
				}
        }}}
		...
		/************载入视图 ****************/
		$arr_view[]='proc_hr/hr_dim/index';
		$arr_view[]='proc_hr/hr_dim/index_js';
				...
				foreach ($arr_field_search as $f) {
					...
					switch ($f)
					{
                        case 'c_id':
                            ...
                            break;
						default:
							if(isset($GLOBALS['m_hr_dim']['text'][$f]) && isset($GLOBALS['m_hr_dim']['text'][$f][$v[$f]]) )
								$v[$f]=$GLOBALS['m_hr_dim']['text'][$f][$v[$f]];
					}
	...
	public function import()
	{
		...
		if($row_num)
		{
			...
			while (TRUE)
			{
				...
				$arr_post['btn']='save';
				$arr_rtn=$this->m_hr_dim->load($arr_get,$arr_post);
