 ...
 * 配置类
 */
class M_proc_contact extends CI_Model {
	
	private $acl_list;
	private $p_id='PROC_CONTACT';
	...
	public function m_define()
    {
    	...
    	$GLOBALS[$p_id]['text']['d_acl'] = array(
			ACL_PROC_CONTACT_SUPER=>'超级',
			ACL_PROC_CONTACT_ACL=>'权限分配',
			ACL_PROC_CONTACT_USER=>'操作人',
		);
    ...
    {
    	$this->load->model($this->p_id.'/m_contact');
    	$this->m_contact->create_import_xlsx();
    }
}