 ...
 *  
    家庭信息_犯罪
 */
class M_hr_family_crime extends CI_Model {
	
	//@todo 主表配置
	private $table_name='hr_family_crime';
	private $pk_id='hr_fc_id';
	private $table_form;
	private $arr_table_form=array();
	private $title='犯罪记录';
	private $model_name = 'm_hr_family_crime';
	private $url_conf = 'proc_hr/hr_family_crime/edit';
    ...
    {
    	//@todo 定义
    	if( defined('LOAD_M_HR_FAMILY_CRIME') ) return;
    	define('LOAD_M_HR_FAMILY_CRIME', 1);
