...
class M_contact extends CI_Model {
	...
	//@todo 主表配置
	private $table_name='sys_contact';//数据表
	private $pk_id='c_id';//数据表主键
	private $table_form;
	private $arr_table_form=array();
	private $title='联系人';//标题
	private $model_name = 'm_contact';//模型名称
	private $url_conf = 'proc_contact/contact/edit';//编辑页面
	private $proc_id = 'proc_contact';//节点
