        ...
        <div id="l_<?=$time?>"
		 	...
		 	<div data-options="region:'north',border:false"
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>身份证件</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
							...
							<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_hr/m_hr_idcard','身份证件','proc_hr/hr_idcard/import')">导入</a>
						</td>
		       			<td style="width:'50%';text-align:right;">
		 			...
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
	                    ...
	                    <tr>
                            ...
                            <td style="height:35px;vertical-align:text-center;" >
								<input name="content[hr_idc_type]"
									   oaname="content[hr_idc_type]"
									   ...
									   data-options="err:err,
						    						 ...
						    						 textField:'text',
					    			   				 ...
					    			   				 width:'200',
					    			   				 multiline:false,
					    			   				 data: [<?= element('hr_idc_type', $json_field_define) ?>],
					    			   				 panelHeight:'auto',
					    			   				 panelMaxHeight:120,
					    			   				 panelWidth:'',
                            ...
                            <td style="height:35px;vertical-align:text-center;" >
								<input name="content[hr_idc_name]"
									   oaname="content[hr_idc_name]"
	                    ...
	                    <tr>
                            ...
                            <td style="height:35px;vertical-align:text-center;" colspan="3">
                            	<input name="content[hr_idc_code]"
					    			   oaname="content[hr_idc_code]"
					    			   class="easyui-textbox oa_input"
					    			   data-options="err:err,
					    			   				 height:'25',
					    			   				 width:'100%',
                          ...
                          <tr>
                            ...
                            <td style="height:35px;vertical-align:text-center;" colspan="3">
                            	<input name="content[hr_idc_note]"
					    			   oaname="content[hr_idc_note]"
					    			   class="easyui-textbox oa_input"
					    			   data-options="err:err,
					    			   				 height:'50',
					    			   				 width:'100%',
