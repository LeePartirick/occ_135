        ...
        <div id="l_<?=$time?>"
		 	...
		 	<div data-options="region:'north',border:false"
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>犯罪记录</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
							...
							<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_hr/m_hr_family_crime','犯罪记录','proc_hr/hr_family_crime/import')">导入</a>
						</td>
		       			<td style="width:'50%';text-align:right;">
		 			...
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
							<td style="height:35px;vertical-align:text-center;" colspan="4">
								<span class="field_s">描述</span>
								<input name="content[hr_fc_description]"
									   oaname="content[hr_fc_description]"
