        ...
        <div id="l_<?=$time?>" 
		 	...
		 	<div data-options="region:'north',border:false" 
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>职务</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
							...
							<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_hr/m_hr_zw','职务管理','proc_hr/hr_zw/import')">导入</a>
						</td>
		       			<td style="width:'50%';text-align:right;">
		 		...
		 		<form id="f_<?=$time?>" class="easyui-form" method="post" data-options="novalidate:false" time="<?=$time?>"> 
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
							...
							<td colspan="3">
								<input name="content[zw_name]"
									   oaname="content[zw_name]"
						...
						<tr>
							...
							<td style="height:35px;vertical-align:text-top;"  colspan="4">
								<input name="content[zw_note]"
									   oaname="content[zw_note]"
									   class="easyui-textbox oa_input"
									   data-options="err:err,
					    			   				 height:'50',
					    			   				 width:'100%',
