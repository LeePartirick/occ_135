        ...
        <div id="l_<?=$time?>" 
		 	...
		 	<div data-options="region:'north',border:false" 
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>开票回款计划</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
		       				...
		       				<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_gfc/m_bp','开票回款计划','proc_gfc/bp/import')">导入</a>
		       			</td>
		       			<td style="width:'50%';text-align:right;">
		 			...
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
							...
							<td style="height:35px;vertical-align:text-center;"  colspan="3">
								<input name="content[bp_note]"
									   oaname="content[bp_note]"
