	 ...
	 <div title="索引列表" style="padding:5px;">  
	 	...
	 	<div class="easyui-layout" 
			...
			<div data-options="region:'center'" style="">
		 			...
		 			<tr>
		 				<td style="">
				    			    ...
				    			    data-options="err:err,
				    			    			 ...
				    			    			 labelWidth:80,
				    			   				 ...
				    			   				 onChange: function(nV,oV)
				    			   				 {
				    			   				 	...
				    			   				 	if( arr_n[0] == arr_o[0] && arr_n[1] == arr_o[1])
				    			   				 	return;
				    			   				 	
				    			   				 	fun_load_time_node<?=$time?>(nV);
							...
							<div id="menu_more_<?=$time?>" style="width:100px;">   
	 		   				...
	 		   				<a href="javascript:void(0);"  
		 					   class="easyui-linkbutton" 
		 					   onClick="load_table_export<?=$time?>();fun_person_index_search($('#table_export<?=$time?>'),'<?=$url?>',$('#table_search<?=$time?>'))"
				...
				<table id="table_export<?=$time?>" no_page=""></table>
			</div>
