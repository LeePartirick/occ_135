        ...
        <div id="l_<?=$time?>" 
		 	...
		 	<div data-options="region:'north',border:false" 
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>发票类型</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
		       				...
		       				<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_bud/m_invoice_type','发票类型','proc_bud/invoice_type/import')">导入</a>
		       			</td>
		       			<td style="width:'50%';text-align:right;">
		 	...
		 	<div data-options="region:'center',border:false" style="padding:5px;">
		 		<form id="f_<?=$time?>" class="easyui-form" method="post" data-options="novalidate:false" time="<?=$time?>"> 
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
							<td class="field_s oa_op" oaname="content[it_name]" style="height:35px;text-align: left">
								发票类型
							</td>
							<td colspan="3" oaname="content[it_name]">
								<input name="content[it_name]"
									   oaname="content[it_name]"
						...
						<tr>
							...
							<td style="height:35px;vertical-align:text-center;" colspan="3" >
								<input type="checkbox" 
									   class="oa_input"
									   value="1"
									   name="content[it_no_new]"
									   oaname="content[it_no_new]">
							</td>
						</tr>
						<tr>
							...
							<td colspan="3">
								<input name="content[it_taking_count]"
									   ...
									   data-options="err:err,
													 ...
													 data:[<?=element('field_count', $json_field_define)?>]
													 ">
							</td>
						...
						<tr>
							...
							<td colspan="3">
								<input name="content[it_tax_count]"
						...
						<tr>
							...
							<td style="height:35px;vertical-align:text-top;"  colspan="3">
								<input name="content[it_note]"
									   oaname="content[it_note]"
									   class="easyui-textbox oa_input"
									   data-options="err:err,
					    			   				 height:'50',
					    			   				 width:'100%',
