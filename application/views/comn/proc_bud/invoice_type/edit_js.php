        ...
        $('#f_<?=$time?>').form('submit',{
            ...
            onSubmit:function(param){
                ...
                if(check)
                {
                    ...
                    param.btn=btn;
                    param['content[it_taking_count]']=data_form['content[it_taking_count]'];
                    param['content[it_tax_count]']=data_form['content[it_tax_count]'];
                }
                else
                {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if('<?=$act?>'=='<?=STAT_ACT_CREATE?>')
                        {
                            ...
                            url+='/act/<?=STAT_ACT_EDIT?>/it_id/'+json.id
