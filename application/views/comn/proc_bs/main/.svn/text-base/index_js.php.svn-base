...
$(document).ready(function(){
	...
	document.title =document.title+'-回款管理' ;
...
//		border:false,
	    ...
	    data:[
			  {id:'bs',name:'回款管理',iconCls:''},
			  {id:'bs_item',name:'回款明细',iconCls:''},
	  	],
...
function fun_open_tab_center<?=$time?>(op)
{
	...
	else
	{
		...
		{ 
			case '回款管理':
			url="proc_bs/bs/index/fun_open/tab.html";
			break;
			case '回款明细':
			url="proc_bs/bs_item/index/fun_open/tab.html";
			break;
		}
