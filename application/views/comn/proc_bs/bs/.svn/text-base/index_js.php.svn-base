...
function load_table_index<?=$time?>()
{
	...
	var col=[[   
		...
		{field:'bs_note',title:'备注',width:200,halign:'center',align:'center',sortable:true,
			formatter: fun_index_formatter<?=$time?>
		},
	...
	var fcol=[[
				...
				{field:'bs_sum',title:'回款金额',width:120,halign:'center',align:'right',sortable:true,
					formatter: fun_index_formatter<?=$time?>
				},
