        ...
        <div id="l_<?=$time?>" 
		 	...
		 	<div data-options="region:'north',border:false" 
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>信息系统申请</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
		       				...
		       				<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_office/m_office_apply','信息系统申请','proc_office/office_apply/import')">导入</a>
		 	...
		 	<div data-options="region:'center',border:false" style="padding:5px;">
		 		...
		 		<div style="position: absolute;right:20px;top:5px;width:40px;">
		 			...
		 			<a href="javascript:void(0)" oaname="btn_im" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-im'" style="width:35px;margin-bottom:5px;" title="308" onClick="fun_im_wl('<?=$offa_id?>','<?=$pp_id?>')"></a>
		 		</div >
		 			...
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
                            ...
                            <td style="height:35px;vertical-align:text-center;" > 
                            	<input name="content[offa_c_apply_s]" 
					    			   oaname="content[offa_c_apply_s]"
					    			   id="txtb_offa_c_apply_s<?=$time?>"
					    			   class="easyui-textbox oa_input"
					    			   data-options="err:err,
					    			   				 height:'25',
					    			   				 width:'200',
													 validType:['errMsg[\'#hd_err_f_<?=$time?>\']'],
													 fun_ready: 'load_offa_c_apply<?=$time?>()'
													 ">
								<input id="txtb_offa_c_apply<?=$time?>" 
									   name="content[offa_c_apply]"
									   oaname="content[offa_c_apply]"
									   class="oa_input"
									   type="hidden"/>						 
                            </td>
                            <td class="field_s" style="height:35px;vertical-align:text-center;"  > 
                            ...
                            <td style="height:35px;vertical-align:text-center;" > 
                            	<input name="content[offa_c_id_s]" 
					    			   oaname="content[offa_c_id_s]"
					    			   id="txtb_offa_c_id_s<?=$time?>"
					    			   class="easyui-textbox oa_input"
					    			   data-options="err:err,
					    			   				 height:'25',
					    			   				 width:'200',
													 validType:['errMsg[\'#hd_err_f_<?=$time?>\']'],
													 fun_ready: 'load_offa_c_id<?=$time?>()'
													 ">
													 
								<input id="txtb_offa_c_id<?=$time?>" 
									   name="content[offa_c_id]"
									   oaname="content[offa_c_id]"
									   class="oa_input"
									   type="hidden"/>
						...
						<tr>
                            <td style="height:35px;vertical-align:text-center;" colspan="4"> 
                            	...
                            	<input name="content[offa_note]"
					    			   oaname="content[offa_note]"
					    			   class="easyui-textbox oa_input"
					    			   data-options="err:err,
					    			   				 height:'50',
					    			   				 width:'100%',
