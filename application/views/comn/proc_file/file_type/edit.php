        ...
        <div id="l_<?=$time?>" 
		 	...
		 	<div data-options="region:'north',border:false" 
				...
				<table style="width:800px;margin:0 auto;" class="table_no_line">
		 		...
		 		<br/>
		 		<? }?>
		 		<center><span class="tb_title"><b>文件属性</b></span></center>
		 			...
		 			<tr>
		       		...
		       		<tr>
		       			<td style="width:'50%';">
		       				...
		       				<a href="javascript:void(0)" oaname="btn_import" class="easyui-linkbutton oa_op" data-options="iconCls:'icon-xlsx'" onClick="fun_xlsx_import('proc_file/m_file_type','文件属性','proc_file/file_type/import')">导入</a>
		       			</td>
		       			<td style="width:'50%';text-align:right;">
		 	...
		 	<div data-options="region:'center',border:false" style="padding:5px;">
		 		<form id="f_<?=$time?>" class="easyui-form" method="post" data-options="novalidate:false" time="<?=$time?>"> 
		 			<table id="table_f_<?=$time?>" style="width:800px;margin:0 auto;">
						...
						<tr>
							<td class="field_s oa_op" oaname="content[f_t_name]" style="height:35px;vertical-align:text-center;">
								属性名称
							</td>
							<td class="oa_op" oaname="content[f_t_name]" style="height:35px;vertical-align:text-center;" colspan="3">
								<input name="content[f_t_name]"
									   oaname="content[f_t_name]"
						...
						<tr>
							...
							<td colspan="3">
								<input name="content[f_t_parent_s]"
									   oaname="content[f_t_parent_s]"
									   id="txtb_f_t_parent_s<?=$time?>"
									   class="easyui-textbox oa_input"
									   data-options="err:err,
					    			   				 height:'25',
					    			   				 width:'100%',
													 ...
													 fun_ready: 'load_f_t_parent<?=$time?>()'
													 ">
								<input id="txtb_f_t_parent<?=$time?>"
									   name="content[f_t_parent]"
									   oaname="content[f_t_parent]"
									   class="oa_input"
									   type="hidden"/>
							</td>
						...
						<tr>
							...
							<td >
								<input type="checkbox" 
									   class="oa_input"
									   value="1"
									   name="content[f_t_unique]"
									   oaname="content[f_t_unique]">
							</td>
							<td class="field_s" style="height:35px;text-align: left">
								相关验证
							</td>
							<td >
								<input name="content[f_t_check]"
									   oaname="content[f_t_check]"
									   ...
									   data-options="err:err,
						    						 ...
						    						 textField:'text',
					    			   				 ...
					    			   				 width:'200px',
					    			   				 multiline:false,
					    			   				 data: [<?=element('f_t_check',$json_field_define)?>],
					    			   				 panelHeight:'auto',
					    			   				 panelMaxHeight:120,
					    			   				 panelWidth:'',
													 validType:['errMsg[\'#hd_err_f_<?=$time?>\']'],
						...
						<tr>
							...
							<td colspan="3">
								<input name="content[f_t_proc]"
									   oaname="content[f_t_proc]"
									   id="txtb_f_t_proc<?=$time?>"
									   ...
									   data-options="err:err,
						    						 ...
						    						 missingMessage:'该输入项为必填项',
					    			   				 ...
					    			   				 panelHeight:'auto',
					    			   				 panelMaxHeight:120,
					    			   				 url_l:'base/auto/get_json_proc/from/combobox/field_id/p_id/field_text/p_name',
					    			   				 panelWidth:'300',
					    			   				 //hasDownArrow:true,
													 validType:['errMsg[\'#hd_err_f_<?=$time?>\']'],
													 fun_ready:'load_f_t_proc<?=$time?>()'
													 ">
							</td>
						</tr>
						...
						<tr>
							...
							<td style="height:35px;vertical-align:text-top;"  colspan="3">
								<input name="content[f_t_note]"
									   oaname="content[f_t_note]"
									   class="easyui-textbox oa_input"
									   data-options="err:err,
					    			   				 height:'50',
					    			   				 width:'100%',
